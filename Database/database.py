...
class Connector:
    def __init__(self):
        ...
        cloud_config = {'secure_connect_bundle': 'secure-connect-adultincomecensusprediction.zip'}
    ...
    def master(self):
        ...
        self.session.execute("CREATE TABLE Data(id uuid PRIMARY KEY ,Age int,Sex text,Capital Gain int,Capital Loss int,Hours-Per-Week int,Country text,Employment Type text);")
